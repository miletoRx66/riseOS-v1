    ...
    <div className="min-h-screen bg-[#0a0a0a] p-8">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <select
              ...
              className="bg-[#1a1a1a] border border-[#333] rounded-lg px-4 py-3 text-[#eee] font-['Inter:Regular',sans-serif] text-[14px] focus:border-[#14E9BC] focus:outline-none"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-[#0f0f0f] border border-[#333] rounded-xl p-6 hover:border-[#14E9BC]/50 transition-colors">
            ...
            <p className="font-['Inter:Medium',sans-serif] text-[#bdbdbd] text-[13px] mb-2">
              Taxa de Conclusão
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-[#0f0f0f] border border-[#333] rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#eee] text-[18px] flex items-center gap-2">
                  ...
                  <div key={dept.id} className="group">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="font-['Inter:Semi_Bold',sans-serif] text-[#eee] text-[16px]">
                          {dept.completion}%
                        </span>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-['Inter:Medium',sans-serif] text-[#eee] text-[14px]">
                      Planejamento
                    </span>
                  </div>
                  <span className="font-['Inter:Semi_Bold',sans-serif] text-[#eee] text-[16px]">
        ...
        <div className="bg-[#0f0f0f] border border-[#333] rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-['Inter:Semi_Bold',sans-serif] text-[#eee] text-[14px] mb-2">
                  Performance Acima da Meta
                </h3>
                <p className="font-['Inter:Regular',sans-serif] text-[#bdbdbd] text-[13px] leading-relaxed">
            ...
            {departamentos.map((dept) => {
              ...
              return (
                <Link
                  ...
                  className="block border border-[#333] rounded-xl p-5 hover:border-[#14E9BC] hover:bg-[#14E9BC]/5 transition-all cursor-pointer group"
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-['Inter:Semi_Bold',sans-serif] text-[#eee] text-[16px] group-hover:text-[#14E9BC] transition-colors">
                        {dept.nome}
                      </h3>
                      <p className="font-['Inter:Regular',sans-serif] text-[#bdbdbd] text-[12px]">
                        {dept.membros} membros
                    ...
                    <ArrowRight
                      size={20}
                      className="text-[#555] group-hover:text-[#14E9BC] transition-colors"
                    />
                  </div>
