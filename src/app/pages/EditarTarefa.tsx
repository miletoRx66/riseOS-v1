              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full bg-rise-raised border ${
                      errors.responsavel_id ? "border-[#ff6b6b]" : "border-rise-line"
                    } rounded-lg px-4 py-3 text-rise-fg font-['Inter:Regular',sans-serif] text-[14px] focus:border-[#14E9BC] focus:outline-none`}
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-rise-raised rounded-lg appearance-none cursor-pointer accent-[#14E9BC]"
                  />
                  <div className="flex justify-between text-rise-fg-3 text-[12px] font-['Inter:Regular',sans-serif] mt-1">
                    <span>0%</span>
                    <span>25%</span>
                    <span>50%</span>
                    <span>75%</span>
