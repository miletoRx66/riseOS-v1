    ...
    <div className="mb-8">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          {/* View Toggle */}
          <div className="flex items-center bg-[#0f0f0f] border border-[#333] rounded-lg p-1">
            <button
      ...
      {view === 'grid' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-5 hover:border-[#14E9BC] transition-all">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Contrato desde</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Jan 2024</span>
              </div>
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Receita Mensal</span>
                <span className="text-[#14E9BC] font-['Inter:Semi_Bold',sans-serif]">R$ 45.000</span>
              </div>
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Próxima Renovação</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Jan 2026</span>
              </div>
            </div>

            <div className="pt-4 border-t border-[#333]">
              <div className="flex items-center justify-between mb-2">
                <span className="text-[#bdbdbd] text-[12px] font-['Inter:Regular',sans-serif]">Health Score</span>
          ...
          <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-5 hover:border-[#14E9BC] transition-all">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Contrato desde</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Mar 2023</span>
              </div>
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Receita Mensal</span>
              ...
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Próxima Renovação</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Mar 2026</span>
              </div>
            </div>
          ...
          <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-5 hover:border-[#14E9BC] transition-all">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Contrato desde</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Jun 2022</span>
              </div>
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Receita Mensal</span>
              ...
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Próxima Renovação</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Jun 2026</span>
              </div>
            </div>
          ...
          <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-5 hover:border-[#14E9BC] transition-all">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Primeiro contato</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Out 2024</span>
              </div>
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Receita Estimada</span>
                <span className="text-[#14E9BC] font-['Inter:Semi_Bold',sans-serif]">R$ 32.000</span>
              </div>
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Próximo Follow-up</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">20 Fev 2025</span>
              </div>
            </div>

            <div className="pt-4 border-t border-[#333]">
              <div className="flex items-center justify-between mb-2">
                <span className="text-[#bdbdbd] text-[12px] font-['Inter:Regular',sans-serif]">Interesse</span>
          ...
          <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-5 hover:border-[#14E9BC] transition-all">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Primeiro contato</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Ago 2024</span>
              </div>
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Receita Estimada</span>
              ...
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Próximo Follow-up</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">18 Fev 2025</span>
              </div>
            </div>
          ...
          <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-5 hover:border-[#14E9BC] transition-all">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Solicitação em</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Fev 2025</span>
              </div>
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Receita Estimada</span>
              ...
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Responsável</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Carlos Silva</span>
              </div>
            </div>

            <div className="pt-4 border-t border-[#333]">
              <div className="flex items-center justify-between mb-2">
                <span className="text-[#bdbdbd] text-[12px] font-['Inter:Regular',sans-serif]">Prioridade</span>
          ...
          <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-5 hover:border-[#14E9BC] transition-all">
            ...
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Adicionado em</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Jan 2025</span>
              </div>
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Receita Estimada</span>
              ...
              <div className="flex items-center justify-between text-[13px]">
                <span className="text-[#bdbdbd] font-['Inter:Regular',sans-serif]">Status</span>
                <span className="text-[#eee] font-['Inter:Medium',sans-serif]">Aguardando</span>
              </div>
            </div>
        ...
        <div className="flex gap-4 overflow-x-auto pb-4">
          ...
          <div className="flex-shrink-0 w-[300px]">
            <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-['Inter:Semi_Bold',sans-serif] text-[#eee] text-[15px]">
                  Stand by
                </h3>
              ...
              <div className="space-y-3">
                <div className="bg-[#1a1a1a] border border-[#333] rounded-lg p-4 hover:border-[#9ca3af] transition-all cursor-pointer">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-['Inter:Semi_Bold',sans-serif] text-[#eee] text-[14px]">
                        Alpha Industries
                      </h4>
                    </div>
                  </div>
                  <div className="space-y-1.5 text-[12px]">
                    <div className="flex justify-between">
                      <span className="text-[#bdbdbd]">Receita Est.</span>
                      <span className="text-[#14E9BC] font-['Inter:Semi_Bold',sans-serif]">R$ 65k</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-[#bdbdbd]">Adicionado</span>
                      <span className="text-[#eee]">Jan 2025</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex-shrink-0 w-[300px]">
            <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div className="bg-[#1a1a1a] border border-[#333] rounded-lg p-4 hover:border-[#ffa500] transition-all cursor-pointer">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#14E9BC] to-[#28d939] rounded flex items-center justify-center text-[#0a0a0a] font-['Inter:Bold',sans-serif] text-[14px]">
                      NS
                    </div>
                  ...
                  <div className="space-y-1.5 text-[12px]">
                    ...
                    <div className="flex justify-between">
                      <span className="text-[#bdbdbd]">Responsável</span>
                      <span className="text-[#eee]">Carlos Silva</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex-shrink-0 w-[300px]">
            <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div className="bg-[#1a1a1a] border border-[#333] rounded-lg p-4 hover:border-[#60a5fa] transition-all cursor-pointer">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#14E9BC] to-[#28d939] rounded flex items-center justify-center text-[#0a0a0a] font-['Inter:Bold',sans-serif] text-[14px]">
                      EP
                    </div>
                  ...
                  <div className="space-y-1.5 text-[12px]">
                    ...
                    <div className="flex justify-between">
                      <span className="text-[#bdbdbd]">Follow-up</span>
                      <span className="text-[#eee]">18 Fev</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex-shrink-0 w-[300px]">
            <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div className="bg-[#1a1a1a] border border-[#333] rounded-lg p-4 hover:border-[#a78bfa] transition-all cursor-pointer">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#14E9BC] to-[#28d939] rounded flex items-center justify-center text-[#0a0a0a] font-['Inter:Bold',sans-serif] text-[14px]">
                      DS
                    </div>
                  ...
                  <div className="space-y-1.5 text-[12px]">
                    ...
                    <div className="flex justify-between">
                      <span className="text-[#bdbdbd]">Interesse</span>
          ...
          <div className="flex-shrink-0 w-[300px]">
            <div className="bg-[#0f0f0f] border border-[#333] rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div className="bg-[#1a1a1a] border border-[#333] rounded-lg p-4 hover:border-[#28d939] transition-all cursor-pointer">
                  <div className="flex items-center gap-2 mb-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#14E9BC] to-[#28d939] rounded flex items-center justify-center text-[#0a0a0a] font-['Inter:Bold',sans-serif] text-[14px]">
                      MC
                    </div>
                  ...
                  <div className="space-y-1.5 text-[12px]">
                    <div className="flex justify-between">
                      <span className="text-[#bdbdbd]">Receita/mês</span>
                      <span className="text-[#14E9BC] font-['Inter:Semi_Bold',sans-serif]">R$ 125k</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-[#bdbdbd]">Health Score</span>
