            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-4 flex-1">
                ...
                <div className="flex-1">
                  <h3 className="font-['Inter:Semi_Bold',sans-serif] text-rise-fg text-[18px] mb-1">
                    {form.titulo}
                  </h3>
                  <p className="font-['Inter:Regular',sans-serif] text-rise-fg-2 text-[14px] mb-3">
                    {form.descricao}
                  </p>
                  <div className="flex items-center gap-4 text-rise-fg-2 text-[13px]">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  title="Copiar"
                >
                  <Copy size={18} className="text-rise-fg-2" />
                </button>
                {temPermissao && (
                  <>
                    <button
